...
func InitializeServer(cfgFile string) (*Server, error) {
	...
	transaction_usecaseService := ProvideTransactionService()
	gacha_usecaseService := ProvideGachaService()
	handler := ProvideHandler(service, auth_usecaseService, goal_usecaseService, investment_usecaseService, transaction_usecaseService, gacha_usecaseService, logger)
